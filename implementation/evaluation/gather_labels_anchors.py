...
def main():
	...
	parser.add_argument('-d',  '--dataset',      type=str,   default='test_set_vehicle/XML',     help="Path to the dataset folder to read from. Default is './data/eval_set'.")
	parser.add_argument('-f',  '--image_format', type=str,   default='jpg',                 help="Format of the images to process. Default is 'jpg'.")
	parser.add_argument('-o',  '--output_file',  type=str,   default='test_vehicle_gt.txt',  help="TensorBoard port number. Default is 'labels_anchors.txt'.")
